...
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="mb-4 d-flex align-items-center">
            ...
            <div class="modal fade-modal" id="trackerModal" tabindex="-1" aria-labelledby="nuevoProyecto" aria-hidden="true">
                ...
                <div class="modal-content-modal">
                  ...
                  <div class="modal-body-modal">
                    <form method="post" action="equipos.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="id">ID_Entrenador</label>
                        <input type="number" class="form-control" id="id" name="id2" placeholder="id" required>
                      </div>
                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                      <!-- Variables para distinguir -->
                      <button type="submit" name="accion" value="<?php echo $accion; ?>"
  ...
  {
    // Imprimir un script de JavaScript para recargar la página
  

    $pdo = conexion();
    try {
      $stmt = $pdo->prepare("SELECT  nombre, ciudad, Foto, IdEntrenador FROM equipo");
