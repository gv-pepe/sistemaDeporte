...
<?php require_once("./Controladores/controladorVisitas.php");
require_once("./Controladores/numeroVisitas.php");?>

<?php
require_once("./Controladores/controladorVisitas.php");
require_once("./Controladores/numeroVisitas.php");
  ...
  <header class="site-navbar py-4" role="banner">
    <div class="container">
      <div class="d-flex align-items-center">
        ...
        <li><a style="position: absolute; top: 10px; color:white; right: 10px;"">Usuarios</a></li>

          <nav class="site-navigation position-relative text-right" role="navigation">
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              
              <li><a href="index.php" class="nav-link">Liga</a></li>
              <li><a href="vistas/usuarios/partidos.php" class="nav-link">Partidos</a></li>
              <li><a href="vistas/usuarios/jugadores.php" class="nav-link">Jugadores</a></li>
              <li><a href="vistas/usuarios/equipos.php" class="nav-link">Equipos</a></li>
              <li><a href="vistas/usuarios/altasbajas.php" class="nav-link">Bitacora</a></li>
        ...
        <div class="col-lg-3">
          <div class="widget mb-3">
            ...
            <ul class="list-unstyled links">
              <li><a href="./vistas/admin/indexAdministrador.php">Admin</a></li>
              <li><a href="./vistas/entrenador/indexEntrenador.php">Coach</a></li>
